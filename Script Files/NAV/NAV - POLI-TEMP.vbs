...
BeginDialog POLI_TEMP_dialog, 0, 0, 246, 65, "Dialog"
  DropListBox 40, 30, 125, 45, "TABLE (Search by TEMP code)"+chr(9)+"INDEX (Search by a word or topic) ", Temp_table_index
  ButtonGroup ButtonPressed
    OkButton 190, 15, 50, 15
    CancelButton 190, 40, 50, 15
