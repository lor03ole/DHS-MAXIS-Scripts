...
elseif worker_county_code = "x162" then     
    agency_office_array = array("Ramsey", "CAC (Bigelow)", "AIFC", "Fairview", "Midway", "North St.Paul") 'adding additional location for Ramsey County
...
ELSEIF worker_county_code = "x162" THEN
	IF inteview_location = "Ramsey" THEN   'adding additional location to Ramsey County's locations - this is main office
    		agency_address.street = "160 Kellogg Blvd. E." 
    		agency_address.city = "Saint Paul" 
    		agency_address.zip = "55101" 
    	ELSEIF interview_location = "CAC (Bigelow)" THEN 'adding this offsite location, so worker at this location can direct client to here
		agency_address.street = "450 N. Syndicate St, Suite 250"
		agency_address.city = "Saint Paul"
		agency_address.zip = "55104"
    	ELSEIF interview_location = "AIFC" THEN 'RC additional offsite location
		agency_address.street = "579 Wells Street"
		agency_address.city = "Saint Paul"
		agency_address.zip = "55130"
    	ELSEIF interview_location = "Fairview" THEN 'RC additional offsite location
		agency_address.street = "1910 W Co RD B, Suite 124"
		agency_address.city = "Saint Paul"
		agency_address.zip = "55113"
    	ELSEIF interview_location = "Midway" THEN 'RC additional offsite location
		agency_address.street = "1821 University Ave, Ste. N263"
		agency_address.city = "Saint Paul"
		agency_address.zip = "55104"
    	ELSEIF interview_location = "North St.Paul" THEN 'RC additional offsite location
		agency_address.street = "2098 11th Avenue"
		agency_address.city = "North Saint Paul"
